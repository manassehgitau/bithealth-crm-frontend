...
function Navbar() {
    ...
    // Define a mapping for routes to dynamic titles
    const getPageTitle = (pathname) => {
        if (pathname.includes('/adminDashboard')) {
            ...
            return 'BitHealth'; // Default title
        }
    };
        ...
        <div className='fixed w-screen top-0 left-0 z-5'>
            <div className='text-grey-900 p-4 flex items-center justify-between bg-gray-100 dark:bg-dark-default dark:text-white'>
                <div className='space-y-1 flex flex-col'>
                    ...
                    <h1 className='hidden md:inline text-sm md:text-2xl font-bold md:pl-20 lg:pl-68'>{pageTitle}</h1>
                    
                    <p className='hidden md:inline text-gray-600 dark:text-gray-300 text-sm md:text-md md:pl-20 lg:pl-68'>
                ...
                <div className='flex justify-between gap-4 md:gap-7'>
                    ...
                    <button 
                        className='hidden md:inline text-lg dark:bg-white text-white bg-purple-default dark:text-dark-default px-3 lg:px-4 rounded-full cursor-pointer' 
                        onClick={toggleTheme}
                    >
